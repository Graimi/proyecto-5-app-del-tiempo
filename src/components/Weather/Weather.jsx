    ...
    <div className="wt">
      ...
      <article className="wt-weather">
        ...
        <div className="wt-weather-info pressure caution">
          <img
            src="https://res.cloudinary.com/dwsffp1eq/image/upload/v1685787037/App%20Tiempo/icons/icons8-atmospheric-pressure-64_jrhawo.png"
            alt="cloud"
            className="wt-sunrise-sunset-icon"
          />
          <p>100</p>
        </div>
        <div className="wt-weather-info visibility caution">
          <img
            src="https://res.cloudinary.com/dwsffp1eq/image/upload/v1685785518/App%20Tiempo/icons/icons8-eye-64_rtygt6.png"
            alt="cloud"
            className="wt-sunrise-sunset-icon"
          />
          <p>10</p>
